...
def visualize_query(root_widget, query):
    plan = get_json()
    ...
    print(type(plan))
    root_node = create_tree.build_tree([plan[0]['Plan']])[0]
    match_dict = create_tree.build_invert_relation(query, root_node)
...
if __name__ == '__main__':
    ...
    visualize_button.bind('<Button-1>', lambda event: visualize_query(root, retrieveInput()))
